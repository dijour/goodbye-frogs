...
class Answer extends Component {
  ...
  renderAnswers(i){
    ...
    let partial;
    if (this.props.a === 'paypal'){
      partial = (<div><a href="https://www.paypal.me/deandijour" target="_blank" rel="noopener noreferrer">$ $ $ $ $ $ $</a><div style={{fontSize: '18px'}}>(JK <a href="https://github.com/jffng/goodbye-frogs" target="_blank" rel="noopener noreferrer">here's the code.</a> Also this design is pretty much a stolen item (from Jeff, which he also pretty much stole - like father, like son) #Took™)</div></div>);
    } else {
